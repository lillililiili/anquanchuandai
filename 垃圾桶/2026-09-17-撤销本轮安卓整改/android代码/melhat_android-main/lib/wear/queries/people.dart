                  ...
                  children: [
                    WearCard(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '${textOf(person['personCode'])} · ${textOf(person['teamName'], '班组未知')}',
                            style: TextStyle(
                              color: Theme.of(
                                context,
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        OutlinedButton.icon(
                          onPressed: () => context.push(
                            '/events?personId=${Uri.encodeComponent(widget.id)}',
                          ),
                          icon: const Icon(Icons.notifications_outlined),
                          label: const Text('查看相关告警'),
                        ),
                      ],
                    ),
                    const SizedBox(height: 20),
                    PersonLocationPanel(personId: widget.id),
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 4),
                                  Text(
                                    '上报 ${formatTime(item['lastReportedAt'])}\n领用 ${formatTime(item['issuedAt'])}',
                                    style: TextStyle(
                                      fontSize: 12,
                                      color: Theme.of(
                                        context,
