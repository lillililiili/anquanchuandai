...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    resolve: { alias: {
      ...
      '@intercom-entry': fileURLToPath(new URL(mock ? './src/mock/IntercomEntry.vue' : './src/components/video/IntercomUnavailable.vue', import.meta.url)),
      ...
      '@alarm-provider': fileURLToPath(new URL(mock ? './src/mock/alarm-provider.js' : './src/api/alarm-provider.js', import.meta.url)),
