...
const filters = reactive({}), filterNames = { type: '设备类型', lifecycle: '生命周期', relation: '领用状态', communication: '通信状态' }
