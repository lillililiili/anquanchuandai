<template>
   <div class="app-container">
      ...
      <el-table ref="roleRef" v-loading="loading" :data="roles.slice((pageNum - 1) * pageSize, pageNum * pageSize)" :row-key="getRowKey" @row-click="clickRow" @selection-change="handleSelectionChange">
