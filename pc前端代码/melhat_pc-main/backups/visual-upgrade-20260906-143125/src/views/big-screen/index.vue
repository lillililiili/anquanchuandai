      ...
      <div class="header-center">
        <div class="header-content">
          <div class="header-logo-centered">
            <svg-icon icon-class="helmet" class-name="header-logo-icon" />
          </div>
          <h1 class="header-title">分体式智能安全帽管理平台</h1>
        </div>
      </div>
      ...
      <section class="screen-left">
        ...
        <div class="screen-card">
          ...
          <div class="card-header">
            ...
            <span class="card-extra" @click="goToSos">查看全部</span>
          </div>
          <div class="card-body">
        ...
        <div class="screen-card">
          ...
          <div class="card-header">
            ...
            <span class="card-extra" @click="goToIntercom">查看全部</span>
          </div>
          <div class="card-body">
...
const tooltipStyle = { backgroundColor: 'rgba(19,26,35,0.96)', borderColor: 'rgba(116,167,223,0.28)', textStyle: { color: '#f1f5f9' } }
const axisLabelStyle = { color: '#9eabb9', fontSize: 10 }
...
function loadChartStats() {
  ...
  listAlarmPage({ current: 1, size: 1000, startTimeFrom: startDate, startTimeTo: endDate }).then(res => {
    ...
    setAlarmStatsOptions({
      ...
      legend: { top: 20, left: 'center', textStyle: { color: '#9eabb9', fontSize: 11 }, itemWidth: 12, itemHeight: 12, padding: 0 },
      grid: { left: '10%', right: '5%', top: '26%', bottom: '15%' },
...
// Fixed dark wallboard palette: restrained contrast, operational status first.
$screen-bg: #0c1118;
$card-bg: #131a23;
$card-bg-light: #18212b;
$border-glow: rgba(132, 151, 174, 0.22);
$border-glow-strong: rgba(93, 156, 236, 0.42);
$text-primary: #f1f5f9;
$text-secondary: #9eabb9;
$accent-cyan: #74a7df;
$accent-blue: #4f8ff7;
$accent-green: #39b980;
$accent-yellow: #d9a441;
$accent-orange: #c9833e;
$accent-red: #e06363;
